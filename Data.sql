...
CREATE TABLE `events` (
  ...
  PRIMARY KEY (`id`,`organizators_id`),
  KEY `fk_events_organizators1_idx` (`organizators_id`),
  CONSTRAINT `fk_events_organizators1` FOREIGN KEY (`organizators_id`) REFERENCES `organizators` (`id`)
...
INSERT INTO `events` VALUES (2,'Birthday',2),(3,'Exam-test-party',9);
...
-- Dump completed on 2023-08-10 22:46:36
